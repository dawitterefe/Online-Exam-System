                        ...
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                            <thead class="bg-gray-300 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th scope="col"
                                        class="py-3 pl-0 pr-2 text-xs font-large tracking-wider text-left text-gray-700 uppercase dark:text-gray-400">
                                        Name
                                    </th>
                                    ...
                                    <th scope="col"
                                        class="py-3 pl-9  text-xs tracking-wider text-left text-gray-700 uppercase dark:text-gray-400">
                                        Started at
                                    </th>

                                    <th scope="col"
                                        class="py-3 pl-8 pr-3 text-xs tracking-wider text-left text-gray-700 uppercase dark:text-gray-400">
                                        Remaining
                                    </th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <td
                                        ...
                                        {{ ($statuses->currentPage() - 1) * $statuses->perPage() +
                                        $loop->iteration }}
                                    </td>
                                    <td
                                        class="py-1 pl-6 pl-3 pr-0 text-sm font-medium text-gray-700 whitespace-nowrap dark:text-white">
                                        <img src="{{asset((\App\Models\User::findOrFail(\App\Models\Student::findOrFail($status->student_id)->user_id))->avatar)}}"
                                    ...
                                    <td
                                        ...
                                        {{\App\Models\User::findOrFail(\App\Models\Student::findOrFail($status->student_id)->user_id)->name
                                        }}
                                        {{\App\Models\User::findOrFail(\App\Models\Student::findOrFail($status->student_id)->user_id)->father_name}}
                                    </td>
                                    <td
                                        class="py-2 pl-5 pr-1 text-sm font-medium text-gray-700 whitespace-nowrap dark:text-white">
                                        {{\App\Models\User::findOrFail(\App\Models\Student::findOrFail($status->student_id)->user_id)->gender
                                        }}</td>
                                    <td
                                        class="py-2 px-1 text-sm font-medium text-gray-700 whitespace-nowrap dark:text-white">
                                        {{$status->student_id}}</td>
                                    <td
                                        class="py-2 pl-5 text-sm font-medium text-gray-700 whitespace-nowrap dark:text-white">
                                        {{$status->started_at}}</td>
                                    <td
                                        class="py-2 pl-10 px-3 text-sm font-medium text-gray-700 whitespace-nowrap dark:text-white">
                                        {{$status->remaining_time}} Min</td>
                                    ...
                                    <td
                                        ...
                                        {{$status->finished_at}}
                                        @else <div class="flex items-center gap-1"><div><x-iconpark-loading-o class="w-5 h-5" /> </div><div>{{'Not yet finished...'}}</div></div>
                                        @endif
                                    </td>
