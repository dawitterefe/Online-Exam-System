                        ...
                        <div class="ml-2 w-full flex-1">
                            <div>
                                <div class="mt-2 text-3xl font-bold leading-8 ">
                                    {{auth()->user()->teacher->courses->count()}}</div>
                    ...
                    <div class="p-5">
                        ...
                        <div class="ml-2 w-full flex-1">
                            <div>
                                <div class="mt-2 text-3xl font-bold leading-8 ">
                                    {{
                                    \App\Models\Exam::whereIn('course_id',(auth()->user()->teacher->courses)->pluck('id'))->count()}}
                                </div>
        ...
        <div class="flex items-center gap-5 px-5 pt-3">
                ...
                <a href="#courses">
                    <div class="p-5">
                        ...
                        <div class="ml-2 w-full flex-1">
                            <div>
                                <div class="mt-2 text-3xl font-bold leading-8 ">
                                    {{\App\Models\Exam::whereDoesntHave('statuses', function ($query) {
                                    $query->whereNull('finished_at');})->select('exams.id') ->distinct()->count();}}
                                </div>
            ...
            <div
                ...
                <a href="#courses">
                    <div class="p-5">
                        <div class="flex justify-end">
                            <x-fas-clock class="h-7 w-7 text-yellow-500 dark:text-yellow-400 " />
                        </div>
                        <div class="ml-2 w-full flex-1">
                            <div>
                                <div class="mt-2 text-3xl font-bold leading-8 ">
                                    {{\App\Models\Exam::whereHas('statuses', function ($query) {
                                    $query->whereNull('finished_at');})->select('exams.id') ->distinct()->count();}}
                                </div>

                                <div class="mt-1 text-base text-gray-600 dark:text-gray-500">Ongoing Exams
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="pr-5 pt-10 w-full">
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700  rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        (auth()->user()->teacher->courses->pluck('id')))->get() as $exam)
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td
        ...
        <div class="flex  gap-5">
            ...
            <div class="pl-5 pt-6 w-full">
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700  rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        @foreach (\App\Models\Exam::whereDoesntHave('statuses', function ($query) {
                        $query->whereNull('finished_at');})->select('exams.id')->distinct()->get() as $exam)
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td
                                class="py-2 pl-6 pr-1 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white rounded-tl-lg  rounded-bl-lg">
                                {{ $loop->iteration }}
                            ...
                            <td
                                class=" py-2 pr-3 pl-0 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="w-30 truncate"> {{\App\Models\Exam::findOrFail($exam->id)->name }} </div>
                            </td>
                            <td class="py-2 px-1 text-sm font-medium text-gray-700 whitespace-nowrap dark:text-white">
                                {{\App\Models\Course::findOrFail(\App\Models\Exam::findOrFail($exam->id)->course_id)->course_code}}
                            </td>
            ...
            <div class="pr-5 pt-6 w-full">
                <div id="courses"
                    ...
                    <div class="text-xl">Ongoing Exams</div>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700  rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        @foreach (\App\Models\Exam::whereHas('statuses', function ($query) {
                        $query->whereNull('finished_at');})->select('exams.id')->distinct()->get() as $exam)
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td
                                class="py-2 pl-6 pr-1 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white rounded-tl-lg  rounded-bl-lg">
            ...
            <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700  rounded-lg">
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <td class=" py-2 pr-3 pl-0 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <div class="w-30 truncate"> {{$exam->name }} </div>
                        </td>
                        <td class="py-2 px-1 text-sm font-medium text-gray-700 whitespace-nowrap dark:text-white">
                            {{$exam->course_code}}</td>
