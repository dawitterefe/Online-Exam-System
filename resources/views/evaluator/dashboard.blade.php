                        ...
                        <div class="ml-2 w-full flex-1">
                            <div>
                                <div class="mt-2 text-3xl font-bold leading-8 ">
                                    {{auth()->user()->evaluator->courses->count()}}</div>
                    ...
                    <div class="p-5">
                        ...
                        <div class="ml-2 w-full flex-1">
                            <div>
                                <div class="mt-2 text-3xl font-bold leading-8 ">
                                    {{
                                    \App\Models\Exam::whereIn('course_id',(auth()->user()->evaluator->courses)->pluck('id'))->count()}}
                                </div>
            ...
            <div class="pl-5 pt-10 w-min">
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700  rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        @foreach (auth()->user()->evaluator->courses as $course)
            ...
            <div class="pr-5 pt-10 w-full">
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700  rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        (auth()->user()->evaluator->courses->pluck('id')))->get() as $exam)
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td
                            ...
                            <td
                                ...
                                {{$exam->evaluations()->wherePivot('approved', true)->count()}} Evaluators
                            </td>
