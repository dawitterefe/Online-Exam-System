<nav aria-label="secondary" x-data="{ open: false }"
    ...
    <div class="flex items-center gap-3">
        ...
        <x-dropdown align="right" width="48">
            <x-slot name="trigger">
                <button
                    class="flex items-center text-sm py-1 px-1 font-medium text-gray-500 rounded-md transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none focus:ring focus:ring-cyan-500  focus:ring-offset-white dark:focus:ring-offset-dark-eval-1 dark:text-gray-400 dark:hover:text-gray-200">
                    <div class="inline-flex items-center gap-2">
                        <div> <img src="{{asset(Auth::user()->avatar)}}" class="w-8 h-8 mx-auto rounded-full"
                                alt="Avatar" /> </div>
