                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                @foreach ($users as $user)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td
                                            class="py-4 pl-6 pl-3 pr-0 text-sm font-medium text-gray-700 whitespace-nowrap dark:text-white">
                                            <img src="{{ asset($user->avatar) }}" class="w-7 rounded-full"
                                                alt="Avatar" />
                                        </td>
                                        <td
                                            class="py-4 pr-3 pl-0 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            {{ $user->name }} {{ $user->father_name }}</td>
                                        <td
                                            class="py-4 px-1 text-sm font-medium text-gray-700 whitespace-nowrap dark:text-white">
                                            {{ $user->gender }}</td>
                                        <td
                                            class="py-4 px-3 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            {{ $user->email }}</td>
                                        <td
                                            class="py-4 px-3 text-sm font-medium text-gray-700 whitespace-nowrap dark:text-white">
                                            {{ $user->role->name }}</td>
                                        <td
                                            class="py-4 px-3 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
