            ...
            <div class="overflow-x-auto shadow-md sm:rounded-lg">
                <div class="inline-block min-w-full align-middle bg-white shadow sm:rounded-lg dark:bg-gray-800">
                    <div class="overflow-hidden ">
                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="grid grid-cols-3 gap-2">
                                            ...
                                            <div class="w-[180px] truncate">
                                                <a
                                                    href="{{ route('admin.detach_student_courses', ['student_id'=>$student->id, 'course_id'=>$course->id]) }}"><i
                        ...
                        <form method="POST" action="{{ route('admin.assign_student_courses', $student->id) }}">
                            @csrf
                            @method('HEAD')
                            {{-- course checkbox --}}
